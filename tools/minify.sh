...
/Users/gba/bin/Sencha/Cmd/sencha compile --classpath=app.js,app,$EXT/packages/core/src,$EXT/packages/core/overrides,$EXT/classic/classic/src,$EXT/classic/classic/overrides \
       exclude -all \
       and \
